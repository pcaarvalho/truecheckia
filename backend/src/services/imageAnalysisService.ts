...
export class ImageAnalysisService {
  ...
  private async performBasicImageAnalysis(
    ...
    if (
      fileName_lower.includes('generated') ||
      fileName_lower.includes('ai') ||
      fileName_lower.includes('synthetic')
    ) {
      confidence += 20;
    ...
    if (
      fileName_lower.includes('photo') ||
      fileName_lower.includes('img') ||
      fileName_lower.includes('pic')
    ) {
      confidence -= 5;
