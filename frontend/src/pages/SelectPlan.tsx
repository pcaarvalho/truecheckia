...
import { 
  Check, X, Loader2, Crown, Rocket, Briefcase, Gift,
  Sparkles, Shield, Zap, Users, BarChart3, FileText,
...
const SelectPlan: React.FC = () => {
  ...
  const getPlanColor = (planName: string) => {
    switch (planName) {
      ...
      case 'ENTERPRISE':
        return 'border-gold-300 hover:border-gold-400';
      default:
        return 'border-gray-300 hover:border-gray-400';
    }
  };
                ...
                `}>
                  ...
                  <div className="text-center mb-8">
                    <div className={`
                      ...
                      ${plan.name === 'FREE' ? 'bg-gray-800/50 text-gray-400' :
                        plan.name === 'STARTER' ? 'bg-blue-900/50 text-blue-400' :
                        plan.name === 'PRO' ? 'bg-purple-900/50 text-purple-400' :
          ...
          <div className="mt-16 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-gray-900/50 backdrop-blur-xl rounded-xl p-6 border border-gray-800">
                ...
                <p className="text-gray-400 text-sm">Sim! Você pode cancelar ou mudar seu plano quando quiser, sem taxas adicionais.</p>
              </div>
              ...
              <div className="bg-gray-900/50 backdrop-blur-xl rounded-xl p-6 border border-gray-800">
                ...
                <p className="text-gray-400 text-sm">Você tem 7 dias grátis para testar todos os recursos dos planos pagos.</p>
              </div>
              ...
              <div className="bg-gray-900/50 backdrop-blur-xl rounded-xl p-6 border border-gray-800">
                ...
                <p className="text-gray-400 text-sm">Não! Você pode começar o trial sem precisar cadastrar cartão de crédito.</p>
              </div>
            </div>
            
            <p className="text-gray-400 mt-12">
              Ainda tem dúvidas? 
              <a href="/contact" className="text-purple-400 hover:text-purple-300 ml-2 inline-flex items-center">
                Fale conosco
