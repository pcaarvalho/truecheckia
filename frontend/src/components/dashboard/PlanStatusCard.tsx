...
export const PlanStatusCard = () => {
  ...
  const trialDaysRemaining = isTrialActive && trialEndsAt ? getDaysRemaining(trialEndsAt.toString()) : null;
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-2xl font-bold mb-1">
            Plano {plan}
            {isTrialActive && (
              <span className="ml-2 text-sm bg-white/20 px-2 py-1 rounded-full">TRIAL</span>
            )}
          </h3>
