        ...
        <div className="relative flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="text-xl font-bold text-white">🎉 Bem-vindo ao TrueCheckIA!</h3>
            </div>

            <p className="text-blue-100 mb-4 max-w-2xl">
              Você agora tem acesso à tecnologia mais avançada de detecção de IA. Pronto para
              começar sua primeira análise? Vamos te mostrar como usar a plataforma!
            </p>
